      ...
      {selectedFood.map((item, index) => (
        ...
        >
          ...
          <div className="flex flex-col w-full ">
            <h2 className="text-lg font-bold mb-2 text-white font-sans">{item.title}</h2>
            ...
            <div className=" flex-1 w-full h-full flex items-end justify-end">
              <Button className=" bg-primary hover:bg-primary/80 text-primary-foreground font-sans">
                View Details
              </Button>
            </div>
          </div>
