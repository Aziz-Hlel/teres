  ...
  return (
    <section id="experience" className="relative py-36 px-6 bg-[#070619]">
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <p className="font-body text-[10px] tracking-[0.6em] uppercase text-primary/70 mb-5">Discover</p>
          ...
          {experiences.map((exp, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-display text-xl tracking-wider text-foreground mb-5">{exp.title}</h3>
