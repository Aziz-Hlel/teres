      ...
      <section className="relative h-[100vh] flex items-center justify-center overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="max-w-xl mx-auto text-white/50 text-sm md:text-base tracking-[0.2em] uppercase leading-relaxed font-light">
            Born from the vision of creating a space where Art Deco meets
            modernity, our lounge offers a timeless escape.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-card/30">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl tracking-wide text-foreground mb-6">
              What Drives Us
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {values.map((v, i) => (
              <div
                key={i}
                className="text-center p-8 border border-border hover:border-primary/40 transition-all duration-500 bg-card/50 border-glow"
              >
      ...
      <section className="py-24 px-6">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="font-body text-muted-foreground leading-relaxed">
            Our team is composed of award-winning mixologists, pastry chefs, and
            passionate professionals who share a common goal: to provide you
            with the best. Each member brings their unique expertise to create
